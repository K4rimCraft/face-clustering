...
print(
    f"Successfully loaded {len(X_train)} training faces and {len(X_val)} validation faces!")
...
model = models.Sequential([
    ...
    # Drops 30% of connections randomly to prevent overfitting
    layers.Dropout(0.3),
...
model.compile(
    optimizer='adam',
    # Used when labels are integers (0, 1, 2)
